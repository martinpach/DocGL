...
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone, city, workplace, validity_date, appointments_duration, working_hours_set) values("doctor@who.sk", "doctor", "who", "00a1cec95d41d45f77f0f280eebbfa3c", "doctorwho", CURDATE(), 10, 0, "0949473196", "Kosice", "Kukucinova 5", "2017-05-11", 20, true);
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone, city, workplace, validity_date, appointments_duration, working_hours_set) values("obi.wan@kenobi.sk", "Obi-Wan", "Kenobi", "00a1cec95d41d45f77f0f280eebbfa3c", "obiwan", CURDATE()+ INTERVAL -1 DAY, 5, 1, "0942223896", "Kosice", "Prazska 8", "2017-05-11", 20, true);
...
insert into Appointments(date, time, note, doctor_id, patient_id, patient_first_name, patient_last_name) values("2017-05-24", "7:30", "Headache", 1, 1, "Janko", "Hrasko");
