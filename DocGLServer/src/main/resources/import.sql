insert into Admins(email, first_name, last_name, password, user_name) values("rasto@button.sk", "rasto", "button", "5b5c51be5daa8548667254d666379b0a", "admin");
...
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone, city, workplace, validity_date, appointments_duration, working_hours_set, approved) values("obi.wan@kenobi.sk", "Obi-Wan", "Kenobi", "00a1cec95d41d45f77f0f280eebbfa3c", "doc2", CURDATE()+ INTERVAL -1 DAY, 5, 1, "0942223896", "Kosice", "Prazska 8", "2017-05-15", 20, true, true);
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone, city, workplace, approved) values("qui.gon@jinn.de", "Qui-Gon", "Jinn", "00a1cec95d41d45f77f0f280eebbfa3c", "doc3", CURDATE()+ INTERVAL -2 DAY, 3, 2, "0945463155", "Presov", "Komenskeho 34", true);
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone, city, workplace) values("r2.d2@doctor.com", "R2", "D2", "00a1cec95d41d45f77f0f280eebbfa3c", "doc4", CURDATE(), 20, 1, "09568989898", "Kosice", "Zimna 16");
