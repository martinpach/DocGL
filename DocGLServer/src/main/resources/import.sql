...
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values("doctor@who.sk", "doctor", "who", "00a1cec95d41d45f77f0f280eebbfa3c", "doctorwho", CURDATE()+ INTERVAL -1 DAY, 10, 0, "0949473196");
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values("obi.wan@kenobi.sk", "Obi-Wan", "Kenobi", "00a1cec95d41d45f77f0f280eebbfa3c", "obiwan", CURDATE()+ INTERVAL -1 DAY, 5, 1, "0942223896");
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values("qui.gon@jinn.de", "Qui-Gon", "Jinn", "00a1cec95d41d45f77f0f280eebbfa3c", "jinn", CURDATE()+ INTERVAL -2 DAY, 3, 2, "0945463155");
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values("r2.d2@doctor.com", "R2", "D2", "00a1cec95d41d45f77f0f280eebbfa3c", "r2d2", CURDATE(), 20, 1, "09568989898");
...
insert into Appointments(date, time, note, doctor_id, patient_id) values(CURDATE(), CURTIME(), "Grandma Anna", 1, 2);
insert into Appointments(date, time, note, doctor_id, patient_id) values(CURDATE(), CURTIME(), "Mother Erica", 1, 1);
