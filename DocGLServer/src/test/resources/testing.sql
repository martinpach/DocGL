...
insert into Appointments(date, time, note, doctor_id, patient_id, patient_first_name, patient_last_name) values('2017-05-24', '7:30:00', 'Mother Erica', 1, 1, 'Janko', 'Hrasko');
