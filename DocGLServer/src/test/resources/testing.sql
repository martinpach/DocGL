...
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values('doctor@who.sk', 'doctor', 'who', '00a1cec95d41d45f77f0f280eebbfa3c', 'doctorwho', CURDATE(), 10, 0, '0949473196');
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values('obi.wan@kenobi.sk', 'Obi-Wan', 'Kenobi', '00a1cec95d41d45f77f0f280eebbfa3c', 'obiwan', CURDATE(), 5, 1, '0942223896');
insert into Doctors(email, first_name, last_name, password, user_name, registration_date, likes, specialization, phone) values('qui.gon@jinn.de', 'Qui-Gon', 'Jinn', '00a1cec95d41d45f77f0f280eebbfa3c', 'jinn', CURDATE(), 3, 2, '0945463155');
